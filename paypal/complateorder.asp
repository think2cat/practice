...
sendXML = sendXML + "		<DoExpressCheckoutPaymentReq xmlns=""urn:ebay:api:PayPalAPI"">" & vbCrlf
sendXML = sendXML + "			<DoExpressCheckoutPaymentRequest xsi:type=""ns:SetExpressCheckoutRequestType"">" & vbCrlf
sendXML = sendXML + "			<Version xmlns=""urn:ebay:apis:eBLBaseComponents"" xsi:type=""xsd:string"">1.0</Version>" & vbCrlf
sendXML = sendXML + "				<DoExpressCheckoutPaymentRequestDetails xmlns=""urn:ebay:apis:eBLBaseComponents"">" & vbCrlf
sendXML = sendXML + "					<Token xsi:type=""ebl:ExpressCheckoutTokenType"">" & session("Token") & "</Token>" & vbCrlf
sendXML = sendXML + "					<PayerID>" & session("PayerID") & "</PayerID>" & vbCrlf
sendXML = sendXML + "					<PaymentAction>Sale</PaymentAction>" & vbCrlf
sendXML = sendXML + "					<PaymentDetails xmlns=""urn:ebay:apis:eBLBaseComponents"">" & vbCrlf
...
sendXML = sendXML + "					</PaymentDetails>" & vbCrlf
sendXML = sendXML + "				</DoExpressCheckoutPaymentRequestDetails>" & vbCrlf
sendXML = sendXML + "			</DoExpressCheckoutPaymentRequest>" & vbCrlf
sendXML = sendXML + "		</DoExpressCheckoutPaymentReq>" & vbCrlf
sendXML = sendXML + "	</SOAP-ENV:Body>" & vbCrlf
