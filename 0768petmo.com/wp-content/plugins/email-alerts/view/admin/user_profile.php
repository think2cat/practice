				...
				<div>
					<label for="ea_sub_publish_post">
						<input 
							...
							<?php _e('Notify me when posts are published'); ?>
					</label></div>
			</td>
		</tr>
...
?>
		...
		<tr>
			<th scope="row" rowspan="2"><?php _e('Comment notifications'); ?></th>
			<td>
				...
				<div>
					<label for="ea_sub_hold_comment">
						<input 
							...
							<?php _e('Notify me when comments are held for moderation'); ?>
					</label>
				</div>				
				...
				<div>
					<label for="ea_sub_approve_comment">
						<input 
							...
							<?php _e('Notify me when comments are approved onto the site'); ?>
					</label>
				</div>
